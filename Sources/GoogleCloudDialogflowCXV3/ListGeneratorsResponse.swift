...
// limitations under the License.
  ...
  ///
  /// [google.cloud.dialogflow.cx.v3.Generators.ListGenerators]: <doc:GeneratorsClient/listGenerators(request:options:)>
    ...
    Sendable
  {
    ...
    /// Initialize a new instance of `ListGeneratorsResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListGeneratorsResponse().with { $0.generators = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([Generator].self, forKey: .generators) {
