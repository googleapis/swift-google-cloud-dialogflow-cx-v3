...
// limitations under the License.
  ...
  ///
  /// [google.cloud.dialogflow.cx.v3.Tools.DeleteTool]: <doc:ToolsClient/deleteTool(request:options:)>
  public struct DeleteToolRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
