...
// limitations under the License.
  ...
  public struct ListExamplesRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `ListExamplesRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListExamplesRequest().with { $0.parent = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.cx.v3.ListExamplesRequest"
    }
