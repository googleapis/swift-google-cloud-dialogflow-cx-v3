...
// limitations under the License.
  ...
  extension Clients {
    ...
    class ToolsTransport: ToolsStub {
      ...
      public func createTool(
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowCXV3.Tool.self, from: data)
      }
      ...
      public func listTools(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowCXV3.ListToolsResponse.self, from: data)
      }
      ...
      public func listToolVersions(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowCXV3.ListToolVersionsResponse.self, from: data)
      }
      ...
      public func createToolVersion(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowCXV3.ToolVersion.self, from: data)
      }
      ...
      public func restoreToolVersion(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowCXV3.RestoreToolVersionResponse.self, from: data)
      }
