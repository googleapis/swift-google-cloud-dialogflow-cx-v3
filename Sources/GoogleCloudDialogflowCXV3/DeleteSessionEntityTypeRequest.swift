...
// limitations under the License.
  ...
  ///
  /// [google.cloud.dialogflow.cx.v3.SessionEntityTypes.DeleteSessionEntityType]: <doc:SessionEntityTypesClient/deleteSessionEntityType(request:options:)>
  public struct DeleteSessionEntityTypeRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `DeleteSessionEntityTypeRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = DeleteSessionEntityTypeRequest().with { $0.name = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.cx.v3.DeleteSessionEntityTypeRequest"
    }
