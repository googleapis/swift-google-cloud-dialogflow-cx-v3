...
// limitations under the License.
    ...
    Sendable
  {
    ...
    /// Initialize a new instance of `ListSessionEntityTypesResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListSessionEntityTypesResponse().with { $0.sessionEntityTypes = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.cx.v3.ListSessionEntityTypesResponse"
    }
