    ...
    class SessionEntityTypesTransport: SessionEntityTypesStub {
      ...
      public func listSessionEntityTypes(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v3/\(pathVariable0)/entityTypes"
        }()
        var query = [
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowCXV3.ListSessionEntityTypesResponse.self, from: data)
      }
      ...
      public func getSessionEntityType(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowCXV3.SessionEntityType.self, from: data)
      }
      ...
      public func updateSessionEntityType(
        ...
        let path = try { () throws -> Swift.String in
          guard let pathVariable0 = request.sessionEntityType.map({ $0.name }),
            !pathVariable0.isEmpty
          else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.session_entity_type.name' is not set or is empty")
          }
          return "/v3/\(pathVariable0)"
        }()
        var query = [
