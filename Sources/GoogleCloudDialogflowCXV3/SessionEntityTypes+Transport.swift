      ...
      public func listSessionEntityTypes(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path = "/v3/\(pathVariable0)/entityTypes"
            var query = [
        ...
        let (path, query, configure) = try {
            ...
            guard
              let pathVariable0 = try GoogleCloudGax._RoutingMatcher.pathValue(
                ...
                matching: [
                  .literal("projects/"), .singleWildcard, .literal("/locations/"), .singleWildcard,
                  .literal("/agents/"), .singleWildcard, .literal("/sessions/"), .singleWildcard,
                  .literal("/entityTypes/"), .singleWildcard,
                ],
                fieldName: "name")
            else {
              return nil
          ...
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "name",
              expecting: "projects/*/locations/*/agents/*/sessions/*/entityTypes/*"
            )
            paths.append(builder.build())
          }
          do {
            ...
            builder.maybeAdd(
              ...
              matching: [
                .literal("projects/"), .singleWildcard, .literal("/locations/"), .singleWildcard,
                .literal("/agents/"), .singleWildcard, .literal("/environments/"), .singleWildcard,
                .literal("/sessions/"), .singleWildcard, .literal("/entityTypes/"), .singleWildcard,
              ],
              fieldName: "name",
              expecting: "projects/*/locations/*/agents/*/environments/*/sessions/*/entityTypes/*"
            )
            paths.append(builder.build())
          }
          throw GoogleCloudGax.RequestError.binding(GoogleCloudGax.BindingError(paths: paths))
      ...
      public func updateSessionEntityType(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            guard
              let pathVariable0 = try GoogleCloudGax._RoutingMatcher.pathValue(
                request.sessionEntityType.map({ $0.name }),
                matching: [
                  .literal("projects/"), .singleWildcard, .literal("/locations/"), .singleWildcard,
                  .literal("/agents/"), .singleWildcard, .literal("/sessions/"), .singleWildcard,
                  .literal("/entityTypes/"), .singleWildcard,
                ],
                fieldName: "session_entity_type.name")
            else {
              return nil
            }
            let path = "/v3/\(pathVariable0)"
