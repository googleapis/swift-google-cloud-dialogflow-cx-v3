...
// limitations under the License.
  ...
  extension Clients {
    final class TransitionRouteGroupsTransport: TransitionRouteGroupsStub {
        ...
        let (path, query, configure) = try {
            ...
            guard
              let pathVariable0 = try GoogleCloudGax._RoutingMatcher.pathValue(
                ...
                matching: [
                  ...
                  .literal("/agents/"), .singleWildcard, .literal("/flows/"), .singleWildcard,
                ],
                fieldName: "parent")
            else {
              return nil
            }
            let path = "/v3/\(pathVariable0)/transitionRouteGroups"
            var query = [
          ...
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "parent",
              expecting: "projects/*/locations/*/agents/*/flows/*"
            )
        ...
        let (path, query, configure) = try {
            ...
            guard
              let pathVariable0 = try GoogleCloudGax._RoutingMatcher.pathValue(
                ...
                matching: [
                  .literal("projects/"), .singleWildcard, .literal("/locations/"), .singleWildcard,
                  .literal("/agents/"), .singleWildcard, .literal("/flows/"), .singleWildcard,
                  .literal("/transitionRouteGroups/"), .singleWildcard,
                ],
                fieldName: "name")
            else {
              return nil
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            guard
              let pathVariable0 = try GoogleCloudGax._RoutingMatcher.pathValue(
                ...
                matching: [
                  .literal("projects/"), .singleWildcard, .literal("/locations/"), .singleWildcard,
                  .literal("/agents/"), .singleWildcard, .literal("/transitionRouteGroups/"),
                  .singleWildcard,
                ],
                fieldName: "name")
            else {
          ...
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "name",
              expecting: "projects/*/locations/*/agents/*/flows/*/transitionRouteGroups/*"
            )
            paths.append(builder.build())
          }
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "name",
              expecting: "projects/*/locations/*/agents/*/transitionRouteGroups/*"
            )
            paths.append(builder.build())
          }
          throw GoogleCloudGax.RequestError.binding(GoogleCloudGax.BindingError(paths: paths))
      ...
      public func updateTransitionRouteGroup(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            guard
              let pathVariable0 = try GoogleCloudGax._RoutingMatcher.pathValue(
                request.transitionRouteGroup.map({ $0.name }),
                matching: [
                  .literal("projects/"), .singleWildcard, .literal("/locations/"), .singleWildcard,
                  .literal("/agents/"), .singleWildcard, .literal("/flows/"), .singleWildcard,
                  .literal("/transitionRouteGroups/"), .singleWildcard,
                ],
                fieldName: "transition_route_group.name")
            else {
              return nil
            }
            let path = "/v3/\(pathVariable0)"
