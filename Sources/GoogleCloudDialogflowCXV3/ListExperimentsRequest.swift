...
// limitations under the License.
  ...
  public struct ListExperimentsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `ListExperimentsRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListExperimentsRequest().with { $0.parent = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.cx.v3.ListExperimentsRequest"
    }
