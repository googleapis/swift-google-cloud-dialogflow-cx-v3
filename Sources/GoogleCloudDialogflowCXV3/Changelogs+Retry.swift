...
// limitations under the License.
  ...
  extension Clients {
    final class ChangelogsRetry: ChangelogsStub {
      let inner: any ChangelogsStub
      let options: GoogleGax.ClientOptions

      public init(_ inner: any ChangelogsStub, options: GoogleGax.ClientOptions) {
        self.inner = inner
      ...
      public func listChangelogs(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: ListChangelogsRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func getChangelog(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: GetChangelogRequest, o: GoogleGax.RequestOptions) async throws
