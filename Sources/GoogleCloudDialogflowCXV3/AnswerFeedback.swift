...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public struct RatingReason: Codable, Equatable, GoogleWKT._AnyPackable,
      Sendable
    {
    ...
    public enum Rating: Codable, Equatable, Sendable {
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        case .thumbsUp: return try container.encode("THUMBS_UP")
        case .thumbsDown: return try container.encode("THUMBS_DOWN")
