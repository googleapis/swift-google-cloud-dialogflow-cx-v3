...
// limitations under the License.
  ...
  public struct ExportPlaybookRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(Swift.String.self, forKey: .playbookUri) {
        self.playbookUri = value
      }
      if let value = try container.decodeIfPresent(
        ExportPlaybookRequest.DataFormat.self, forKey: .dataFormat)
      {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.playbookUri, forKey: .playbookUri)
