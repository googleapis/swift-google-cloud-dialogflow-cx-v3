...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var testCaseResults: [TestCaseResult] = []
    ...
    /// Initialize a new instance of `ListTestCaseResultsResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListTestCaseResultsResponse().with { $0.testCaseResults = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([TestCaseResult].self, forKey: .testCaseResults)
      {
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.cx.v3.ListTestCaseResultsResponse"
    }
