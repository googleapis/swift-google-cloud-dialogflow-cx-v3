...
// limitations under the License.
  ...
  extension Clients {
    class WebhooksTransport: WebhooksStub {
      ...
      public func listWebhooks(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v3/\(pathVariable0)/webhooks"
        }()
        var query = [
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowCXV3.ListWebhooksResponse.self, from: data)
      }
      ...
      public func getWebhook(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowCXV3.Webhook.self, from: data)
      }
      ...
      public func updateWebhook(
        ...
        let path = try { () throws -> Swift.String in
          guard let pathVariable0 = request.webhook.map({ $0.name }), !pathVariable0.isEmpty else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.webhook.name' is not set or is empty")
          }
          return "/v3/\(pathVariable0)"
        }()
        var query = [
