...
// limitations under the License.
  ...
  extension Clients {
    final class WebhooksTransport: WebhooksStub {
      ...
      public func listWebhooks(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path = "/v3/\(pathVariable0)/webhooks"
            var query = [
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            guard
              let pathVariable0 = try GoogleCloudGax._RoutingMatcher.pathValue(
                ...
                matching: [
                  .literal("projects/"), .singleWildcard, .literal("/locations/"), .singleWildcard,
                  .literal("/agents/"), .singleWildcard, .literal("/webhooks/"), .singleWildcard,
                ],
                fieldName: "name")
            else {
              return nil
          ...
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "name",
              expecting: "projects/*/locations/*/agents/*/webhooks/*"
            )
            paths.append(builder.build())
          }
          throw GoogleCloudGax.RequestError.binding(GoogleCloudGax.BindingError(paths: paths))
      ...
      public func updateWebhook(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            guard
              let pathVariable0 = try GoogleCloudGax._RoutingMatcher.pathValue(
                request.webhook.map({ $0.name }),
                matching: [
                  .literal("projects/"), .singleWildcard, .literal("/locations/"), .singleWildcard,
                  .literal("/agents/"), .singleWildcard, .literal("/webhooks/"), .singleWildcard,
                ],
                fieldName: "webhook.name")
            else {
              return nil
            }
            let path = "/v3/\(pathVariable0)"
