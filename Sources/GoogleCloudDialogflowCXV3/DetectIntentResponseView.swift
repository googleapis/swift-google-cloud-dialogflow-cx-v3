...
// limitations under the License.
  ...
  public enum DetectIntentResponseView: Codable, Equatable, Sendable {
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:DetectIntentResponseView/unknownStringValue(_:)).
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:DetectIntentResponseView/unknownIntValue(_:)).
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("DETECT_INTENT_RESPONSE_VIEW_UNSPECIFIED")
      case .full: return try container.encode("DETECT_INTENT_RESPONSE_VIEW_FULL")
      case .basic: return try container.encode("DETECT_INTENT_RESPONSE_VIEW_BASIC")
      case .`default`: return try container.encode("DETECT_INTENT_RESPONSE_VIEW_DEFAULT")
