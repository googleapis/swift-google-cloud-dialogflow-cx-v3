...
// limitations under the License.
  ...
  ///
  /// [google.cloud.dialogflow.cx.v3.Tools.DeleteToolVersion]: <doc:ToolsClient/deleteToolVersion(request:options:)>
  public struct DeleteToolVersionRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `DeleteToolVersionRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = DeleteToolVersionRequest().with { $0.name = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.cx.v3.DeleteToolVersionRequest"
    }
