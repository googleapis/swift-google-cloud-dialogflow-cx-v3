...
// limitations under the License.
  ...
  public struct UpdatePageRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `UpdatePageRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = UpdatePageRequest().with { $0.page = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.cx.v3.UpdatePageRequest"
    }
