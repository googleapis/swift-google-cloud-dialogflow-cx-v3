...
// limitations under the License.
    ...
    Sendable
  {
    ...
    /// Initialize a new instance of `ListExperimentsResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListExperimentsResponse().with { $0.experiments = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let experiments = CodingKeys(stringValue: "experiments")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([Experiment].self, forKey: .experiments) {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.experiments, forKey: .experiments)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.cx.v3.ListExperimentsResponse"
    }
