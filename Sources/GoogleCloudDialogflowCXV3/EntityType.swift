...
// limitations under the License.
    ...
    Sendable
  {
    ...
    ///
    /// [google.cloud.dialogflow.cx.v3.EntityTypes.UpdateEntityType]: <doc:EntityTypesClient/updateEntityType(request:options:)>
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let excludedPhrases = CodingKeys(stringValue: "excludedPhrases")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [EntityType.ExcludedPhrase].self, forKey: .excludedPhrases)
      {
        self.excludedPhrases = value
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.excludedPhrases, forKey: .excludedPhrases)
