...
// limitations under the License.
  ...
  extension Clients {
    ...
    class AgentsTransport: AgentsStub {
      ...
      public func listAgents(
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowCXV3.ListAgentsResponse.self, from: data)
      }
      ...
      public func getAgent(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowCXV3.Agent.self, from: data)
      }
      ...
      public func validateAgent(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowCXV3.AgentValidationResult.self, from: data)
      }
      ...
      public func getGenerativeSettings(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowCXV3.GenerativeSettings.self, from: data)
      }
