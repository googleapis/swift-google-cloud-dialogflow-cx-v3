...
// limitations under the License.
  ...
  extension Clients {
    final class SecuritySettingsServiceTransport: SecuritySettingsServiceStub {
      ...
      public func createSecuritySettings(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path = "/v3/\(pathVariable0)/securitySettings"
            let query = [
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            guard
              let pathVariable0 = GoogleCloudGax._RoutingMatcher.value(
                ...
                matching: [
                  .literal("projects/"), .singleWildcard, .literal("/locations/"), .singleWildcard,
                  .literal("/securitySettings/"), .singleWildcard,
                ])
            else {
              return nil
            }
          ...
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "name",
              expecting: "projects/*/locations/*/securitySettings/*"
            )
            paths.append(builder.build())
          }
          throw GoogleCloudGax.RequestError.binding(GoogleCloudGax.BindingError(paths: paths))
      ...
      public func updateSecuritySettings(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            guard
              let pathVariable0 = GoogleCloudGax._RoutingMatcher.value(
                request.securitySettings.map({ $0.name }),
                matching: [
                  .literal("projects/"), .singleWildcard, .literal("/locations/"), .singleWildcard,
                  .literal("/securitySettings/"), .singleWildcard,
                ])
          ...
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "security_settings.name",
              expecting: "projects/*/locations/*/securitySettings/*"
            )
            paths.append(builder.build())
          }
