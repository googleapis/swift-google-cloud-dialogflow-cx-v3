...
// limitations under the License.
  ...
  extension Clients {
    class ChangelogsTransport: ChangelogsStub {
      ...
      public func listChangelogs(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v3/\(pathVariable0)/changelogs"
        }()
        var query = [
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowCXV3.ListChangelogsResponse.self, from: data)
      }
      ...
      public func getChangelog(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowCXV3.Changelog.self, from: data)
      }
