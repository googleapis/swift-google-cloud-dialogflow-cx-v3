...
// limitations under the License.
  ...
  public struct Match: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public enum MatchType: Codable, Equatable, Sendable {
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        case .directIntent: return try container.encode("DIRECT_INTENT")
        case .parameterFilling: return try container.encode("PARAMETER_FILLING")
        case .noMatch: return try container.encode("NO_MATCH")
        case .noInput: return try container.encode("NO_INPUT")
        case .event: return try container.encode("EVENT")
        case .knowledgeConnector: return try container.encode("KNOWLEDGE_CONNECTOR")
