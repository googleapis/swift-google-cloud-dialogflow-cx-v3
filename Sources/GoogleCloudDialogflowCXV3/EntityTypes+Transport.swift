        ...
        let (path, query, configure) = try {
            ...
            guard
              let pathVariable0 = GoogleCloudGax._RoutingMatcher.value(
                ...
                matching: [
                  ...
                  .literal("/agents/"), .singleWildcard, .literal("/entityTypes/"), .singleWildcard,
                ])
            else {
              return nil
            }
          ...
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "name",
              expecting: "projects/*/locations/*/agents/*/entityTypes/*"
            )
      ...
      public func exportEntityTypes(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path = "/v3/\(pathVariable0)/entityTypes:export"
            let query = [
              URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
            ]
            return (path, query)
      ...
      public func importEntityTypes(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path = "/v3/\(pathVariable0)/entityTypes:import"
            let query = [
              URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
            ]
            return (path, query)
