...
// limitations under the License.
    ...
    Sendable
  {
    ...
    /// Initialize a new instance of `ListPagesResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListPagesResponse().with { $0.pages = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.cx.v3.ListPagesResponse"
    }
