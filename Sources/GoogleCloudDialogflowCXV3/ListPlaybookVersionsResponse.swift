...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var playbookVersions: [PlaybookVersion] = []
    ...
    /// Initialize a new instance of `ListPlaybookVersionsResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListPlaybookVersionsResponse().with { $0.playbookVersions = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let playbookVersions = CodingKeys(stringValue: "playbookVersions")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [PlaybookVersion].self, forKey: .playbookVersions)
      {
        self.playbookVersions = value
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.playbookVersions, forKey: .playbookVersions)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.cx.v3.ListPlaybookVersionsResponse"
    }
