...
// limitations under the License.
  ...
  public struct AgentUtterance: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `AgentUtterance`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = AgentUtterance().with { $0.text = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.cx.v3.AgentUtterance"
    }
