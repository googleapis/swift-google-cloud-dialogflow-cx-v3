...
// limitations under the License.
  ...
  public final class DeploymentsClient: Clients.DeploymentsProtocol, Sendable {
    ...
    public init(_ options: GoogleGax.ClientOptions = .init()) throws {
      var inner: any Clients.DeploymentsStub = try Clients.DeploymentsTransport(options)
      inner = Clients.DeploymentsRetry(inner, options: options)
      if let logger = options.logger {
        inner = Clients.DeploymentsLogging(inner, logger: logger)
      }
      self.inner = inner
    }
    ...
    public func listDeployments(
      ...
      let listRpc = {
        (token: Swift.String) async throws -> GoogleCloudDialogflowCXV3.ListDeploymentsResponse in
        var request = byItem
    ...
    /// [google.cloud.dialogflow.cx.v3.Deployment]: <doc:Deployment>
    ///
    /// @Snippet(path: "Deployments_GetDeployment")
    ...
    ///
    /// @Snippet(path: "Deployments_GetLocation")
    ...
    /// [google.longrunning.Operations]: https://www.google.com/search?q=Swift+google.longrunning+OperationsClient
    ///
    /// @Snippet(path: "Deployments_GetOperation")
    func getOperation(
    ...
    /// [google.longrunning.Operations]: https://www.google.com/search?q=Swift+google.longrunning+OperationsClient
    ///
    /// @Snippet(path: "Deployments_CancelOperation")
  ...
  extension Clients {
    /// A Swift protocol to mock `DeploymentsClient`.
    ///
    /// To mock `DeploymentsClient` change your functions to receive
    /// `some DeploymentsProtocol` or `any DeploymentsProtocol`
    /// and pass a mock implementation in your tests.
    public protocol DeploymentsProtocol {
      /// See `DeploymentsClient.listDeployments`.
      func listDeployments(request: ListDeploymentsRequest) async throws
        -> GoogleCloudDialogflowCXV3.ListDeploymentsResponse
      ...
      /// See `DeploymentsClient.getDeployment`.
      func getDeployment(request: GetDeploymentRequest) async throws
        -> GoogleCloudDialogflowCXV3.Deployment
      ...
      /// See `DeploymentsClient.listLocations`.
      ...
      /// See `DeploymentsClient.getLocation`.
      func getLocation(request: GoogleCloudLocation.GetLocationRequest) async throws
        -> GoogleCloudLocation.Location

      /// See `DeploymentsClient.listOperations`.
      ...
      /// See `DeploymentsClient.cancelOperation`.
  ...
  extension Clients.DeploymentsProtocol {
  ...
  public final class DeploymentsClient: Sendable {
    @available(
      *, unavailable, message: "Enable the 'Deployments' trait in Package.swift to use this client."
    )
    public init(_ options: GoogleGax.ClientOptions = .init()) throws {}
