...
// limitations under the License.
  ...
  ///
  /// [google.cloud.dialogflow.cx.v3.EntityTypes.ListEntityTypes]: <doc:EntityTypesClient/listEntityTypes(request:options:)>
    ...
    Sendable
  {
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([EntityType].self, forKey: .entityTypes) {
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.cx.v3.ListEntityTypesResponse"
    }
