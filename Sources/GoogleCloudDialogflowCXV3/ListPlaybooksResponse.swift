...
// limitations under the License.
  ...
  public struct ListPlaybooksResponse: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `ListPlaybooksResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListPlaybooksResponse().with { $0.playbooks = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let playbooks = CodingKeys(stringValue: "playbooks")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([Playbook].self, forKey: .playbooks) {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.playbooks, forKey: .playbooks)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.cx.v3.ListPlaybooksResponse"
    }
  ...
  extension ListPlaybooksResponse: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [Playbook] {
