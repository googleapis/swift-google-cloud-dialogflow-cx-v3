...
// limitations under the License.
  ...
  ///
  /// [google.cloud.dialogflow.cx.v3.Flows.DeleteFlow]: <doc:FlowsClient/deleteFlow(request:options:)>
  public struct DeleteFlowRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = DeleteFlowRequest().with { $0.name = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.cx.v3.DeleteFlowRequest"
    }
