...
// limitations under the License.
  ...
  extension Clients {
    ...
    class SecuritySettingsServiceTransport: SecuritySettingsServiceStub {
      ...
      public func createSecuritySettings(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v3/\(pathVariable0)/securitySettings"
        }()
        let query = [
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowCXV3.SecuritySettings.self, from: data)
      }
      ...
      public func updateSecuritySettings(
        ...
        let path = try { () throws -> Swift.String in
          guard let pathVariable0 = request.securitySettings.map({ $0.name }),
            !pathVariable0.isEmpty
          else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.security_settings.name' is not set or is empty")
          }
          return "/v3/\(pathVariable0)"
        }()
        var query = [
      ...
      public func listSecuritySettings(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowCXV3.ListSecuritySettingsResponse.self, from: data)
      }
