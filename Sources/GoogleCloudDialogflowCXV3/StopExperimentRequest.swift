...
// limitations under the License.
  ...
  ///
  /// [google.cloud.dialogflow.cx.v3.Experiments.StopExperiment]: <doc:Experiments/stopExperiment(request:)>
    ...
    Sendable
  {
    ...
    /// Initialize a new instance of `StopExperimentRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = StopExperimentRequest().with { $0.name = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.cx.v3.StopExperimentRequest"
    }
