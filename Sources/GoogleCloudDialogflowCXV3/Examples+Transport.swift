...
// limitations under the License.
  ...
  extension Clients {
    final class ExamplesTransport: ExamplesStub {
      ...
      public func createExample(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path = "/v3/\(pathVariable0)/examples"
            let query = [
        ...
        let (path, query, configure) = try {
            ...
            guard
              let pathVariable0 = GoogleCloudGax._RoutingMatcher.value(
                ...
                matching: [
                  .literal("projects/"), .singleWildcard, .literal("/locations/"), .singleWildcard,
                  .literal("/agents/"), .singleWildcard, .literal("/playbooks/"), .singleWildcard,
                  .literal("/examples/"), .singleWildcard,
                ])
            else {
              return nil
            }
          ...
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "name",
              expecting: "projects/*/locations/*/agents/*/playbooks/*/examples/*"
            )
            paths.append(builder.build())
          }
          throw GoogleCloudGax.RequestError.binding(GoogleCloudGax.BindingError(paths: paths))
