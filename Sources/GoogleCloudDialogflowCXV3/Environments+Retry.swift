    ...
    final class EnvironmentsRetry: EnvironmentsStub {
      ...
      public func deleteEnvironment(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: DeleteEnvironmentRequest, o: GoogleGax.RequestOptions) async throws -> Void in
      ...
      public func lookupEnvironmentHistory(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: LookupEnvironmentHistoryRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func runContinuousTest(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: RunContinuousTestRequest, o: GoogleGax.RequestOptions) async throws
              -> GoogleLongRunning.Operation
            in
      ...
      public func listContinuousTestResults(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: ListContinuousTestResultsRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func deployFlow(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: DeployFlowRequest, o: GoogleGax.RequestOptions) async throws
              -> GoogleLongRunning.Operation
            in
