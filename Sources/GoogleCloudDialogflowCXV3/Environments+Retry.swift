    ...
    final class EnvironmentsRetry: EnvironmentsStub {
      ...
      public func lookupEnvironmentHistory(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: LookupEnvironmentHistoryRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleCloudDialogflowCXV3.LookupEnvironmentHistoryResponse
            in
            return try await self.inner.lookupEnvironmentHistory(request: r, options: o)
          })
      }
      ...
      public func runContinuousTest(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: RunContinuousTestRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleLongRunning.Operation
            in
            return try await self.inner.runContinuousTest(request: r, options: o)
          })
      }
      ...
      public func listContinuousTestResults(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: ListContinuousTestResultsRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleCloudDialogflowCXV3.ListContinuousTestResultsResponse
            in
            return try await self.inner.listContinuousTestResults(request: r, options: o)
          })
      }
      ...
      public func deployFlow(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: DeployFlowRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleLongRunning.Operation
            in
            return try await self.inner.deployFlow(request: r, options: o)
          })
      }
