...
// limitations under the License.
  ...
  extension Clients {
    ...
    class TransitionRouteGroupsTransport: TransitionRouteGroupsStub {
      ...
      public func listTransitionRouteGroups(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v3/\(pathVariable0)/transitionRouteGroups"
        }()
        var query = [
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowCXV3.ListTransitionRouteGroupsResponse.self, from: data)
      }
      ...
      public func getTransitionRouteGroup(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowCXV3.TransitionRouteGroup.self, from: data)
      }
      ...
      public func updateTransitionRouteGroup(
        ...
        let path = try { () throws -> Swift.String in
          guard let pathVariable0 = request.transitionRouteGroup.map({ $0.name }),
            !pathVariable0.isEmpty
          else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.transition_route_group.name' is not set or is empty")
          }
          return "/v3/\(pathVariable0)"
        }()
        var query = [
