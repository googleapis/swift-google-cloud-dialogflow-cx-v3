...
// limitations under the License.
  ...
  extension Clients {
    final class WebhooksRetry: WebhooksStub {
      ...
      public init(_ inner: any WebhooksStub, options: GoogleGax.ClientOptions) {
        self.inner = inner
      ...
      public func listWebhooks(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: ListWebhooksRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func getWebhook(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: GetWebhookRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func createWebhook(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: CreateWebhookRequest, o: GoogleGax.RequestOptions) async throws
              -> GoogleCloudDialogflowCXV3.Webhook
            in
      ...
      public func updateWebhook(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: UpdateWebhookRequest, o: GoogleGax.RequestOptions) async throws
              -> GoogleCloudDialogflowCXV3.Webhook
            in
      ...
      public func deleteWebhook(
        ...
        try await self._intercept(
          ...
          options: options,
          idempotent: false,
          action: { (r: DeleteWebhookRequest, o: GoogleGax.RequestOptions) async throws -> Void in
