...
// limitations under the License.
    ...
    Sendable
  {
    ...
    /// Initialize a new instance of `ListWebhooksResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListWebhooksResponse().with { $0.webhooks = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let webhooks = CodingKeys(stringValue: "webhooks")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([Webhook].self, forKey: .webhooks) {
        self.webhooks = value
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.cx.v3.ListWebhooksResponse"
    }
