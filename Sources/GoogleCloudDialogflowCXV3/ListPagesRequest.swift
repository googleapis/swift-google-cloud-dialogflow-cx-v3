...
// limitations under the License.
  ...
  public struct ListPagesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `ListPagesRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListPagesRequest().with { $0.parent = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.cx.v3.ListPagesRequest"
    }
