...
// limitations under the License.
  ...
  extension Clients {
    final class DeploymentsTransport: DeploymentsStub {
      ...
      public func listDeployments(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path = "/v3/\(pathVariable0)/deployments"
            var query = [
        ...
        let (path, query, configure) = try {
            ...
            guard
              let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
                ...
                matching: [
                  .literal("projects/"), .singleWildcard, .literal("/locations/"), .singleWildcard,
                  .literal("/agents/"), .singleWildcard, .literal("/environments/"),
                  .singleWildcard, .literal("/deployments/"), .singleWildcard,
                ],
                fieldName: "name")
            else {
              return nil
          ...
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "name",
              expecting: "projects/*/locations/*/agents/*/environments/*/deployments/*"
            )
            paths.append(builder.build())
          }
          throw GoogleGax.RequestError.binding(GoogleGax.BindingError(paths: paths))
