    ...
    class EnvironmentsTransport: EnvironmentsStub {
      ...
      public func listEnvironments(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v3/\(pathVariable0)/environments"
        }()
        var query = [
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowCXV3.ListEnvironmentsResponse.self, from: data)
      }
      ...
      public func getEnvironment(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowCXV3.Environment.self, from: data)
      }
      ...
      public func lookupEnvironmentHistory(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v3/\(pathVariable0):lookupEnvironmentHistory"
        }()
        var query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowCXV3.LookupEnvironmentHistoryResponse.self, from: data)
      }
      ...
      public func runContinuousTest(
        ...
        let path = try { () throws -> Swift.String in
          guard let pathVariable0 = request.environment as Swift.String?, !pathVariable0.isEmpty
            ...
            throw GoogleCloudGax.RequestError.binding(
              "'request.environment' is not set or is empty")
          }
          return "/v3/\(pathVariable0):runContinuousTest"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
      ...
      public func listContinuousTestResults(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v3/\(pathVariable0)/continuousTestResults"
        }()
        var query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowCXV3.ListContinuousTestResultsResponse.self, from: data)
      }
      ...
      public func deployFlow(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v3/\(pathVariable0):deployFlow"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
