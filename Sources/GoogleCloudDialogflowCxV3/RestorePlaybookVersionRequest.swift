...
// limitations under the License.
    ...
    Sendable
  {
    ...
    /// Initialize a new instance of `RestorePlaybookVersionRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = RestorePlaybookVersionRequest().with { $0.name = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.cx.v3.RestorePlaybookVersionRequest"
    }
