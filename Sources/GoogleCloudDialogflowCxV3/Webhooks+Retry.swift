...
// limitations under the License.
  ...
  extension Clients {
    final class WebhooksRetry: WebhooksStub {
      let inner: any WebhooksStub
      let options: GoogleCloudGax.ClientOptions

      public init(_ inner: any WebhooksStub, options: GoogleCloudGax.ClientOptions) {
        self.inner = inner
      ...
      public func listWebhooks(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: ListWebhooksRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleCloudDialogflowCxV3.ListWebhooksResponse
            in
            return try await self.inner.listWebhooks(request: r, options: o)
          })
      }
      ...
      public func getWebhook(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: GetWebhookRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleCloudDialogflowCxV3.Webhook
            in
            return try await self.inner.getWebhook(request: r, options: o)
          })
      }
      ...
      public func createWebhook(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: CreateWebhookRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleCloudDialogflowCxV3.Webhook
            in
            return try await self.inner.createWebhook(request: r, options: o)
          })
      }
      ...
      public func updateWebhook(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: UpdateWebhookRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleCloudDialogflowCxV3.Webhook
            in
            return try await self.inner.updateWebhook(request: r, options: o)
          })
      }
      ...
      public func deleteWebhook(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: DeleteWebhookRequest, o: GoogleCloudGax.RequestOptions) async throws -> Void in
            return try await self.inner.deleteWebhook(request: r, options: o)
          })
      }
