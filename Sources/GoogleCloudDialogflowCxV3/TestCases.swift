...
// limitations under the License.
  ...
  public class TestCasesClient: Clients.TestCasesProtocol {
    ...
    public func listTestCases(
      ...
      let listRpc = {
        (token: String) async throws -> GoogleCloudDialogflowCxV3.ListTestCasesResponse in
        var request = byItem
    ...
    public func listTestCaseResults(
      ...
      let listRpc = {
        (token: String) async throws -> GoogleCloudDialogflowCxV3.ListTestCaseResultsResponse in
        var request = byItem
        request.pageToken = token
