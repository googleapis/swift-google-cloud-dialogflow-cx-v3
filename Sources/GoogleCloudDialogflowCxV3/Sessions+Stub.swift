...
// limitations under the License.
  ...
  extension Clients {
    ...
    class SessionsTransport: SessionsStub {
      ...
      public func detectIntent(
        ...
        let path = try { () throws -> Swift.String in
          guard let pathVariable0 = request.session as Swift.String?, !pathVariable0.isEmpty else {
            throw GoogleCloudGax.RequestError.binding("'request.session' is not set or is empty")
          }
          return "/v3/\(pathVariable0):detectIntent"
        }()
        let query = [
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowCxV3.DetectIntentResponse.self, from: data)
      }
      ...
      public func serverStreamingDetectIntent(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v3/\(pathVariable0):serverStreamingDetectIntent"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
      ...
      public func matchIntent(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v3/\(pathVariable0):matchIntent"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowCxV3.MatchIntentResponse.self, from: data)
      }
      ...
      public func fulfillIntent(
        ...
        let path = try { () throws -> Swift.String in
          guard let pathVariable0 = request.matchIntentRequest.map({ $0.session }),
            !pathVariable0.isEmpty
          else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.match_intent_request.session' is not set or is empty")
          }
          return "/v3/\(pathVariable0):fulfillIntent"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowCxV3.FulfillIntentResponse.self, from: data)
      }
      ...
      public func submitAnswerFeedback(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v3/\(pathVariable0):submitAnswerFeedback"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowCxV3.AnswerFeedback.self, from: data)
      }
