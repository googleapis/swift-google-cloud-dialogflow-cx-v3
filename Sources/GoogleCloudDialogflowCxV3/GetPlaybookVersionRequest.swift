...
// limitations under the License.
  ...
  ///
  /// [google.cloud.dialogflow.cx.v3.Playbooks.GetPlaybookVersion]: <doc:Playbooks/getPlaybookVersion(request:)>
    ...
    Sendable
  {
    ...
    /// Initialize a new instance of `GetPlaybookVersionRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = GetPlaybookVersionRequest().with { $0.name = ... }
    /// ```
    ...
    public static var _anyTypeUrl: String {
      return "type.googleapis.com/google.cloud.dialogflow.cx.v3.GetPlaybookVersionRequest"
    }
