...
// limitations under the License.
  ...
  ///
  /// [google.cloud.dialogflow.cx.v3.Versions.CreateVersion]: <doc:Versions/createVersion(request:)>
    ...
    Sendable
  {
    ...
    /// Initialize a new instance of `CreateVersionOperationMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = CreateVersionOperationMetadata().with { $0.version = ... }
    /// ```
