...
// limitations under the License.
    ...
    Sendable
  {
    ...
    /// isn't the last page.
    public var transitionRouteGroups: [TransitionRouteGroup] = []

    /// Token to retrieve the next page of results, or empty if there are no more
    /// results in the list.
    public var nextPageToken: Swift.String = Swift.String()

    /// Initialize a new instance of `ListTransitionRouteGroupsResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListTransitionRouteGroupsResponse().with { $0.transitionRouteGroups = ... }
    /// ```
    ...
    public static var _anyTypeUrl: String {
      return "type.googleapis.com/google.cloud.dialogflow.cx.v3.ListTransitionRouteGroupsResponse"
    }
