...
// limitations under the License.
  ...
  public class PlaybooksClient: Clients.PlaybooksProtocol {
    ...
    public func listPlaybooks(
      ...
      let listRpc = {
        (token: String) async throws -> GoogleCloudDialogflowCxV3.ListPlaybooksResponse in
        var request = byItem
    ...
    public func listPlaybookVersions(
      ...
      let listRpc = {
        (token: String) async throws -> GoogleCloudDialogflowCxV3.ListPlaybookVersionsResponse in
        var request = byItem
        request.pageToken = token
