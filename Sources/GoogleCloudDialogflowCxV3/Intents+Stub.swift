...
// limitations under the License.
  ...
  extension Clients {
    ...
    class IntentsTransport: IntentsStub {
      ...
      public func listIntents(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v3/\(pathVariable0)/intents"
        }()
        var query = [
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowCxV3.ListIntentsResponse.self, from: data)
      }
      ...
      public func getIntent(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowCxV3.Intent.self, from: data)
      }
      ...
      public func updateIntent(
        ...
        let path = try { () throws -> Swift.String in
          guard let pathVariable0 = request.intent.map({ $0.name }), !pathVariable0.isEmpty else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.intent.name' is not set or is empty")
          }
          return "/v3/\(pathVariable0)"
        }()
        var query = [
      ...
      public func importIntents(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v3/\(pathVariable0)/intents:import"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
      ...
      public func exportIntents(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v3/\(pathVariable0)/intents:export"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
