...
// limitations under the License.
  ...
  public enum ImportStrategy: Codable, Equatable, Sendable {
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:ImportStrategy/unknownStringValue(_:)).
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:ImportStrategy/unknownIntValue(_:)).
