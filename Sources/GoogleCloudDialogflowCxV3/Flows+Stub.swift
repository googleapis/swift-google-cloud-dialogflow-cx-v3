    ...
    class FlowsTransport: FlowsStub {
      ...
      public func createFlow(
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowCxV3.Flow.self, from: data)
      }
      ...
      public func listFlows(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowCxV3.ListFlowsResponse.self, from: data)
      }
      ...
      public func validateFlow(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowCxV3.FlowValidationResult.self, from: data)
      }
