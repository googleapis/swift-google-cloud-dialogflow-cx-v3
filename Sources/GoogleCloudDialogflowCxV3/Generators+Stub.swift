...
// limitations under the License.
  ...
  extension Clients {
    protocol GeneratorsStub {
      ...
      ) async throws -> GoogleCloudDialogflowCxV3.Generator
    ...
    class GeneratorsTransport: GeneratorsStub {
      ...
      public func listGenerators(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v3/\(pathVariable0)/generators"
        }()
        var query = [
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowCxV3.ListGeneratorsResponse.self, from: data)
      }
      ...
      public func getGenerator(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowCxV3.Generator.self, from: data)
      }
      ...
      public func updateGenerator(
        ...
        let path = try { () throws -> Swift.String in
          guard let pathVariable0 = request.generator.map({ $0.name }), !pathVariable0.isEmpty
          else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.generator.name' is not set or is empty")
          }
          return "/v3/\(pathVariable0)"
        }()
        var query = [
