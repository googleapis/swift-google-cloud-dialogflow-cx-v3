...
// limitations under the License.
  ...
  public class EnvironmentsClient: Clients.EnvironmentsProtocol {
    ...
    public func listEnvironments(
      ...
      let listRpc = {
        (token: String) async throws -> GoogleCloudDialogflowCxV3.ListEnvironmentsResponse in
        var request = byItem
    ...
    public func lookupEnvironmentHistory(
      ...
      let listRpc = {
        (token: String) async throws -> GoogleCloudDialogflowCxV3.LookupEnvironmentHistoryResponse
        in
        var request = byItem
        request.pageToken = token
    ...
    public func listContinuousTestResults(
      ...
      let listRpc = {
        (token: String) async throws -> GoogleCloudDialogflowCxV3.ListContinuousTestResultsResponse
        in
        var request = byItem
        request.pageToken = token
