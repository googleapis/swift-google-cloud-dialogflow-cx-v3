...
// limitations under the License.
  ...
  func sample(
    client: ChangelogsClient, projectId: String, locationId: String, agentId: String,
    changelogId: String
  ) async throws {
    let response = try await client.getChangelog(
    ...
    static func main() async throws {
      do {
        ...
        try await sample(
          ...
          agentId: "[placeholder]", changelogId: "[placeholder]")
      } catch {
        print("Error: \(error)")
      }
    }
