...
// limitations under the License.
  ...
  func sample(
    ...
    playbookId: String, exampleId: String
  ) async throws {
    let response = try await client.updateExample(
      request: UpdateExampleRequest()
        .with {
          $0.example = Example().with {
            $0.name =
    ...
    static func main() async throws {
      do {
        ...
        try await sample(
          ...
          agentId: "[placeholder]", playbookId: "[placeholder]", exampleId: "[placeholder]")
      } catch {
        print("Error: \(error)")
      }
    }
