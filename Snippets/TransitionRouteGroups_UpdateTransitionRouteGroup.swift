...
// limitations under the License.
  ...
  func sample(
    ...
    flowId: String, transitionRouteGroupId: String
  ) async throws {
    let response = try await client.updateTransitionRouteGroup(
      request: UpdateTransitionRouteGroupRequest()
        .with {
          $0.transitionRouteGroup = TransitionRouteGroup().with {
            $0.name =
    ...
    static func main() async throws {
      do {
        ...
        try await sample(
          ...
          agentId: "[placeholder]", flowId: "[placeholder]", transitionRouteGroupId: "[placeholder]"
        )
      } catch {
        print("Error: \(error)")
      }
