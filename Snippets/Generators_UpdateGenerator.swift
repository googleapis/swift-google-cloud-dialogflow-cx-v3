...
// limitations under the License.
  ...
  func sample(
    client: GeneratorsClient, projectId: String, locationId: String, agentId: String,
    generatorId: String
  ) async throws {
    let response = try await client.updateGenerator(
    ...
    static func main() async throws {
      do {
        ...
        try await sample(
          ...
          agentId: "[placeholder]", generatorId: "[placeholder]")
      } catch {
        print("Error: \(error)")
      }
    }
